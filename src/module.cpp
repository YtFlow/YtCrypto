...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"YtCrypto.CryptorFactory"))
    {
        return winrt_make_YtCrypto_CryptorFactory();
    }

    if (requal(name, L"YtCrypto.Util"))
    {
        return winrt_make_YtCrypto_Util();
    }
